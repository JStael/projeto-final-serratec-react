  ...
  return (<div>
    ...
    <CardFormulario>
      ...
      <form className="formCadastro" onSubmit={efetuarCadastro}>
        ...
        <div>
          <label>CPF</label>
          <input required type="numeric" value={cpf} onChange={cpfHandle} placeholder="Apenas os 11 digitos" />
        </div>
        <div>
          <label>Telefone</label>
          <input required type="numeric" value={telefone} onChange={(evento) => setTelefone(evento.target.value)} placeholder="(XX) 99999-9999" />
        </div>
        <div>
        ...
        <div>
          <label>Cep</label>
          <input required type="numeric" value={cep} onBlur={obterCep} onChange={cepHandle} placeholder="Apenas os 8 digitos" />
        </div>
        <div>
          <label>Rua</label>
        ...
        <div>
          ...
          <input required type="numeric" value={numero} onChange={(evento) => setNumero(evento.target.value)} placeholder="Digite o número da sua residência" />
        </div>
        <div>
          <label>Bairro</label>
